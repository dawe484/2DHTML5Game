...
router.get('/:urlName', (req, res) => {
  Hero.getHeroByUrlName(req.params.urlName, (err, hero) => {
    ...
    res.render('hero', {
      ...
      power: hero.power, power_inc: hero.power_inc, health: hero.health, health_inc: hero.health_inc,
      ...
      skill1_icon: hero.skills[0].icon_path, skill1_title: hero.skills[0].title, skill1_description: hero.skills[0].description,
      skill2_icon: hero.skills[1].icon_path, skill2_title: hero.skills[1].title, skill2_description: hero.skills[1].description,
      skill3_icon: hero.skills[2].icon_path, skill3_title: hero.skills[2].title, skill3_description: hero.skills[2].description,
      skill4_icon: hero.skills[3].icon_path, skill4_title: hero.skills[3].title, skill4_description: hero.skills[3].description
    });
  });
});
